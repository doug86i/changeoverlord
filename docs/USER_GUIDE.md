...
- **Rare collab glitch:** If someone **adds a sheet** and other users see **duplicate tabs**, refresh the patch page or use **Export JSON** / **Import JSON** to realign the workbook. Engineering detail: [`docs/KNOWN_ISSUES.md`](KNOWN_ISSUES.md) **#83**.
