...
- **Your name** — The first time you open chat in this browser, you are asked for a **display name** (stored locally). You can change it under **Options** later. Messages need a non-empty name to send.
