...
- **Web — Patch workbook (FortuneSheet):** **Dark mode** in-cell editing forces **white** text (including nested spans from cell formatting) so typed text stays readable; **light mode** forces **black** for the same reason.
